package com.fionera.cleaner.bean.ProcessHelper;
    ...
    public AndroidAppProcess(int pid) throws IOException, NotAndroidAppProcessException {
        ...
        if (SYS_SUPPORTS_SCHEDGROUPS) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                LogCat.d(String.format(Locale.CHINA,"name=%s, pid=%d, uid=%d, foreground=%b, cpuacct=%s, cpu=%s",
            ...
            uid = status.getUid();
            LogCat.d(String.format(Locale.CHINA,"name=%s, pid=%d, uid=%d foreground=%b", name, pid, uid, foreground));
        }
