...
public class ViewDragHelper {
     ...
     * the ViewDragHelper with more information activity_about the state of the parent
     ...
     *                    activity_about detecting the start of a drag. Larger values are more
    ...
    private float distanceInfluenceForSnapDuration(float f) {
        f -= 0.5f; // center the values activity_about 0.
        f *= 0.3f * Math.PI / 2.0f;
