...
public class ArcProgress
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = DisplayUtils.sp2px(18);
        min_size = (int) DisplayUtils.dp2px(100);
        default_text_size = DisplayUtils.sp2px(40);
        default_suffix_text_size = DisplayUtils.sp2px(15);
        default_suffix_padding = DisplayUtils.dp2px(4);
        default_suffix_text = "%";
        default_bottom_text_size = DisplayUtils.sp2px(10);
        default_stroke_width = DisplayUtils.dp2px(4);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        textSize = attributes
                .getDimension(R.styleable.ArcProgress_arc_text_size, default_text_size);
        ...
        suffixText = TextUtils.isEmpty(attributes.getString(
                R.styleable.ArcProgress_arc_suffix_text)) ? default_suffix_text : attributes
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            canvas.drawText(text, (getWidth() - textPaint.measureText(text)) / 2.0f, textBaseline,
                            textPaint);
        ...
        if (!TextUtils.isEmpty(getBottomText())) {
            ...
            float bottomTextBaseline = getHeight() - arcBottomHeight - (textPaint
